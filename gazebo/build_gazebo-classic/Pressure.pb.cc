...
static void InitDefaultsscc_info_Pressure_Pressure_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_Pressure_Pressure_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_Pressure_Pressure_2eproto}, {}};

static ::PROTOBUF_NAMESPACE_ID::Metadata file_level_metadata_Pressure_2eproto[1];
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_Pressure_2eproto = nullptr;
static constexpr ::PROTOBUF_NAMESPACE_ID::ServiceDescriptor const** file_level_service_descriptors_Pressure_2eproto = nullptr;

const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_Pressure_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::sensor_msgs::msgs::Pressure, time_usec_),
  PROTOBUF_FIELD_OFFSET(::sensor_msgs::msgs::Pressure, temperature_),
  PROTOBUF_FIELD_OFFSET(::sensor_msgs::msgs::Pressure, absolute_pressure_),
  PROTOBUF_FIELD_OFFSET(::sensor_msgs::msgs::Pressure, pressure_altitude_),
  0,
  1,
  2,
  3,
...
const char descriptor_table_protodef_Pressure_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_Pressure_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_Pressure_2eproto_sccs[1] = {
  &scc_info_Pressure_Pressure_2eproto.base,
};
static ::PROTOBUF_NAMESPACE_ID::internal::once_flag descriptor_table_Pressure_2eproto_once;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Pressure_2eproto = {
  false, false, descriptor_table_protodef_Pressure_2eproto, "Pressure.proto", 140,
  &descriptor_table_Pressure_2eproto_once, descriptor_table_Pressure_2eproto_sccs, descriptor_table_Pressure_2eproto_deps, 1, 0,
  schemas, file_default_instances, TableStruct_Pressure_2eproto::offsets,
  file_level_metadata_Pressure_2eproto, 1, file_level_enum_descriptors_Pressure_2eproto, file_level_service_descriptors_Pressure_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_Pressure_2eproto = (static_cast<void>(::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_Pressure_2eproto)), true);
namespace sensor_msgs {
namespace msgs {
...
class Pressure::_Internal {
 public:
  ...
  static void set_has_absolute_pressure(HasBits* has_bits) {
    (*has_bits)[0] |= 4u;
  }
...
const Pressure& Pressure::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_Pressure_Pressure_2eproto.base);
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 29)) {
          _Internal::set_has_absolute_pressure(&has_bits);
          absolute_pressure_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else goto handle_unusual;
        continue;
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 37)) {
          ...
          pressure_altitude_ = ::PROTOBUF_NAMESPACE_ID::internal::UnalignedLoad<float>(ptr);
          ptr += sizeof(float);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* Pressure::_InternalSerialize(
  ...
  if (cached_has_bits & 0x00000004u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(3, this->_internal_absolute_pressure(), target);
  }

  // required float pressure_altitude = 4;
  if (cached_has_bits & 0x00000008u) {
    target = stream->EnsureSpace(target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::WriteFloatToArray(4, this->_internal_pressure_altitude(), target);
  }
...
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:sensor_msgs.msgs.Pressure)
  ...
  if (_internal_has_absolute_pressure()) {
    // required float absolute_pressure = 3;
    total_size += 1 + 4;
  }
...
void Pressure::InternalSwap(Pressure* other) {
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::memswap<
      PROTOBUF_FIELD_OFFSET(Pressure, pressure_altitude_)
      + sizeof(Pressure::pressure_altitude_)
      - PROTOBUF_FIELD_OFFSET(Pressure, time_usec_)>(
