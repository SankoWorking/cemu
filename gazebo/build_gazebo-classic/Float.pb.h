...
#ifndef GOOGLE_PROTOBUF_INCLUDED_Float_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_Float_2eproto
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_Float_2eproto;
namespace std_msgs {
namespace msgs {
class Float;
...
class Float PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:std_msgs.msgs.Float) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_Float_2eproto);
    return ::descriptor_table_Float_2eproto.file_level_metadata[kIndexInFileMessages];
  }
...
// required float data = 1;
inline bool Float::_internal_has_data() const {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_Float_2eproto
